      ...
      children: [
        ...
        Center(
          child: PopupMenuButton<bool>(
            ...
            itemBuilder: (context) => [
              const PopupMenuItem(value: true, child: Text('kg')),
              const PopupMenuItem(value: false, child: Text('lbs')),
            ],
            child: Container(
              width: 90.w,
              height: 24.h,
    ...
    return Column(
      ...
      children: [
        ...
        PopupMenuButton<bool>(
          ...
          itemBuilder: (context) => [
            const PopupMenuItem(value: true, child: Text('cm')),
            const PopupMenuItem(value: false, child: Text('ft')),
          ],
          child: Container(
            width: 90.w,
            height: 24.h,
