...
class _ProfileEditViewState extends ConsumerState<ProfileEditView> {
  ...
  Future<void> _pickAndUploadImage() async {
    ...
    final pickedFile = await picker.pickImage(
      ...
      imageQuality: 35, // Reduced quality for faster upload
      maxWidth: 512, // Standardizing size
      maxHeight: 512,
    );
    ...
    setState(() {
      ...
      _localImagePath = pickedFile.path; // Instant preview!
    });
    ...
    try {
      ...
      final String storagePath = 'profile_pictures/$fileName';
      
      // Bunny.net Upload
      final dio = dio_pkg.Dio();
      final response = await dio.put(
        'https://storage.bunnycdn.com/sixpack30/$storagePath',
        data: file.openRead(),
        options: dio_pkg.Options(
          headers: {
            'AccessKey': '1881b757-e9fb-46b2-82adf340bfb5-4172-43fe',
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        final downloadUrl = 'https://sixpack30.b-cdn.net/$storagePath?v=${DateTime.now().millisecondsSinceEpoch}';
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(Translations.translate('photo_updated', langCode))),
          );
        }
      } else {
      ...
      if (mounted) {
        final langCode = ref.read(localeProvider).languageCode;
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(Translations.translate('photo_error', langCode))),
        );
      }
    } finally {
      if (mounted) {
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: Translations.translate('enter_name', langCode),
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(10.r)),
                    filled: true,
                    fillColor: Colors.white,
                    counterText: "", // Hides the counter for a cleaner look
                  ),
                ...
                ElevatedButton(
                  ...
                  child: Text(Translations.translate('ok', langCode), style: const TextStyle(color: Colors.white)),
                ),
              ],
            ),
          ),
                  ...
                  TextButton(
                    onPressed: () async {
                      ...
                      if (success) {
                        ...
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text(Translations.translate('auth_error', langCode))),
                          );
                        }
                      }
                    },
